...
fun haveSinglePublicMethod() =
    object : com.tngtech.archunit.lang.ArchCondition<JavaClass>("have single public method") {
...
fun notThrowAnyException() =
    object : com.tngtech.archunit.lang.ArchCondition<JavaClass>("not throw any exception") {
        override fun check(item: JavaClass, events: ConditionEvents) {
            item.methods
